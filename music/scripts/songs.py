...
homepageDir = "/Users/bencelsi/LocalDrive/CODE•••••••••••••••••••••••••/github/bens-homepage/songs/song-files"
...
# list of versions that trump others- can be major (1) or minor (1.1)
hardCodedVersions = {
    "Woke Up": "4.2"
}

# Returns map of song name to its bounce files.
...
copyNewestSongsToDir(srcDir, homepageDir, songMap, "allSongs")
